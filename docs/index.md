...
With the Timestamp Generator Gen3:

- Synchronize up to six Harp devices from a single Timestamp Generator Gen3, or expand to larger systems by daisy-chaining additional devices as repeaters.
...
- Integrates with [Bonsai](https://bonsai-rx.org/) for flexible experiment acquisition and control.
